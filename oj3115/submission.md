...
```text
ให้ดูว่าร้านไหนเปิดบ้างในเวลานั้นๆ
```
...
```text
รับค่าจำนวนร้านแล้วรับค่าเลข ถ้าเลขอยู่ระหว่างช่วงที่ต้องการให้ เพิ่มร้านค่าที่เป็นเป็น 1
```
...
```text
รับจำนวนร้านแล้ววนลูปตามนำนวนร้าน รับค่าเวลาเปิดปิดของร้านตามจำนวน ถ้าร้านเปิดมีค่าเป็น1 ร้านปิดมีค่าเป็น -1วนลูปสะสมค่าร้านที่เปิดลงในลิส ต่อไป วนลูปตั้งแต่นาทีที่0 ถึง หมดวันถ้ามีร้านเปิดยอดรวมจะเพิ่มขึ้นแล้วเก็บยอดรวมของนาทีนั้นไว้
```
...
```text
ขอบเขตเวลาเริ่มต้นและสิ้นสุดวัน
```
...
```text
ช่วงเวลาว่างที่ไม่มีร้านเปิดเลย
```
