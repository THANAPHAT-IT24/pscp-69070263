...
```text
รับข้อความแล้วให้แสดงข้อความโดยอยู่ในกรอบของ*
```
...
```text
แสดง*บนล่าง ระหว่างนั้นก้อนับตัวอักษรว่ามีกี่ตัวแล้าเอาจำนวนของข้อความที่ยาวสุดมาลบ จะได้กรอบคลุมข้อความยาวสุดพอดี
```
...
```text
input มีเว้นวรรคต่อท้ายข้อความ
```
