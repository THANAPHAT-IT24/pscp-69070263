...
```text
โจทย์ให้ใส่ราคาสินค้าแล้วบวก vat service

Input:
โปรแกรมรับจำนวนหนึ่งค่า

Output:
โปรแกรมควรพิมพ์เลขที่ถูกบวก vat service แล้ว

Constraints:
service มีขั้นตํ่าแล้วค่าสูงสุด
```
...
```text
Step 1: อ่านจำนวนราคา
Step 2: นำมาคิดvat
Step 3: นำมาคิด service
Step 4: แสดงผล
