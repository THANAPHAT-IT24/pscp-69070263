...
```text
รับข้อความมาแล้วตรวจสอบว่ามีสระอะไรกี่ตัวบ้างแล้วแสดงผลตัวที่มีว่ามีกี่ตัว
```
...
```text
รับข้อความมาแล้วสร้างตัวแปรเก็บจำนวนแต่ละตัวอักษรแล้วลูปดูทีละตัวอักษรว่าใช่สระไหม พอครบแล้วแสดงผลจำนวนสระแต่ละตัวที่เก็บไว้
```
...
```text
เรียบเรียงเอง เขียนโค้ดเอง testcase เอง
```
