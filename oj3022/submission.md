...
```text
รับค่าอุณหภูมิ แล้วดูว่าเป็นหน่วยอะไร ต้องแปลงเป็นหน่วยอะไรแล้วใส่สูตร แล้วแสดงผล
```
...
```text
แปลกค่าเป็นCก่อนจะได้ใช้สูตรง่ายขึ้น
```
...
```text
แนะนำให้แปลงเป็น celcius ก่อน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ด คิดแนวคิดและนึกคำสั่งเอง
```
