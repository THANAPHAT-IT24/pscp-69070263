...
```text
รับค่าควาเร็วของนํ้าหมึกกับจำนวนคำร้องของคน จากนั้น รับค่าพิกัดบ้านของแต่ละคนแล้วคำนวณว่าจะไปถึงเมื่อไหร่
```
...
```text
เพิ่มพื่นที่วงกลมตามค่าความเร็วนํ้าหมึกแล้วเช็คว่ามันโดนบ้านคนตอนไหน
```
...
```text
คำนวณพื้นที่วงกลมแล้วมาหาระยะห่าง เอาพื้นที่หารเวลาแล้วปัดเศษ
```
...
```text
เลขที่ห่างกันในแกนเดียวตรวจสอบความถูกต้องง่าย
```
...
```text
input ที่ตรวจสอบความถูกต้องง่าย
```
...
```text
บอกว่าต้องเขียนอะไรต่อแล้วอธิบายว่าทำไมต้องทำแบบนั้น
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดและทำความเข้าใจ
```
