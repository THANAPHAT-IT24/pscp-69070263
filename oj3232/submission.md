...
```text
ให้ใส่ว่ากบกระโดดได้ไกลเท่าไหร่และต้องกระโดดไปเป็นระยะทางเท่าไหร่ ให้หาว่าต้องกระโดดกี่ครั้งหรือกระโดดไม่ถึง โดย แต่ละครั้งจะกระโดดได้ไกลน้อยลง2หน่วย
```
...
```text
รับค่าแล้วใช้while loop จนกว่าระยะทางที่กบกระโดดไปจะเท่ากับหรือมากกว่าระยะทางที่อยากไปแล้วลบความไกลของกบลง2ทุกๆครั้งที่ลูป ถ้ากระโดดเหลือ 0 ให้พิม -1
```
...
```text
รับค่าแล้วใช้while loop จนกว่าระยะทางที่กบกระโดดไปจะเท่ากับหรือมากกว่าระยะทางที่อยากไป ถ้าความไกลกระโดดเหลือน้อยกว่า1ให้นับว่ากบกระโดดไม่ถึงแล้วออกจากลูป ถ้ายังไม่ถึง0ก้อให้กระโดด บวกระยะทางและ ลบความไกลกระโดดไปเรื่อยๆ
```
...
```text
ถึงเป้าหมายโดยที่กบไม่ต้องกระโดด
```
...
```text
ค่า input ที่มากที่สุดใน testcase
```
