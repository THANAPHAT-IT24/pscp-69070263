...
```text
โจทย์ให้ฉันรับค่าชื่อแล้วกลับตัวอักษร

Input:
โปรแกรมรับข้อมูลตัวอักษร

Output:
ข้อมูลตัวอักษรที่ถูกกลับหน้าหลัง

Constraints:
input เป็นตัวอักษรเท่านั้น
```
...
```text
Step 1: อ่านข้อความที่ใส่เข้าไป
Step 2: ทำให้ค่าที่ใส่เข้าไปเป็นตัวพิมเล็ก
Step 3: ทำให้ค่าที่ใส่เข้าไปกลับด้าน
Step 4: แสดงผลค่าที่ได้
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่ ดูสไลด์ syntax ไม่ได้
