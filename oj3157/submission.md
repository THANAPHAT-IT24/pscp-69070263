...
```text
รับค่ามาว่าให้+-กี่ครั้ง ถ้าบวกให้เพิ่มคะแนน ถ้าลบให้ลดคะแนนแล้วแสดงผล
```
...
```text
รับค่าจำนวนครั้งแล้วเอามาวนลูป ถ้ารับค่า+ให้เพิ่มคะแนนถ้า-ให้ลดคะแนน
```
...
```text
เหมือนวิธีแรก รับค่าจำนวนครั้งแล้วเอามาวนลูป ถ้ารับค่า+ให้เพิ่มคะแนนถ้า-ให้ลดคะแนน
```
