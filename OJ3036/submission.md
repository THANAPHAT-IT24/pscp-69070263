...
```text
โจทย์ให้หาจำนวนกำแพงที่น้อยที่สุดจากห้องinputไปถึงห้อง1 ให้ใส่ค่าห้องที่อยู่แล้วจะแสดงผลจำนวนกำแพงที่ต้องพังเพื่อให้ไปถึง
```
...
```text
หาว่าอยู่ชั้นไหนแล้วนับจำนวนกำแพงตามชั้นที่อยู่
```
...
```text
หาชั้นและลำดับชั้นแล้วดูว่าเป็นสามเหลี่ยมควำ่หรือหงายแล้วคิดจำนวนกำแพง
```
...
```text
ห้องที่อยู่ชั้นเดียวกันแต่สามเหลี่ยมหันคนละทาง
```
