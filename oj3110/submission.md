...
```text
รับค่าต้นทางปลายทาง และนำ้หนักพัสดุแล้วคำนวณราคา
```
...
```text
ใช้ split แยกรับค่าต้นทางปลายทางรับค่านํ้าหนักแล้วตรวจสอบทีละcaseว่าต้นทางมาจากไหนปลายทางคืออะไรแล้วคำนวณราคาจากตาราง
```
