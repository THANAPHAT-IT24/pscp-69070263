...
```text
ให้ดูว่าผลการออกรางวัลตรงกับที่มีมั้ยแล้วได้เงินรางวัลเท่าไหร่ให้แสดงผล
```
...
```text
ใช้ string slicing แล้วใช้ if else ดักกรณีต่างๆจนครบแล้วแสดงผลเงินรางวัลที่ได้
```
...
```text
เหมือนกับวิธีแรกใช้ string slicing แล้วใช้ if else ดักกรณีต่างๆจนครบแล้วแสดงผลเงินรางวัลที่ได้
```
...
```text
สลากตรงกับผลออกรางวัลทุกตำแหน่ง
```
...
```text
ตรง 3 เลขท้ายแต่ไม่ตรงตัวอักษร
```
