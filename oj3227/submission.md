...
```text
ให้พิมเลขและดอกไพ่แบบย่อๆแล้วให้โปรแกรมแสดงชื่อเต็ม
```
...
```text
แบ่งinputออกเป็น เลขไพ่กับดอกไพ่แล้วดูว่าถ้าเป็นไพ่รูปคนให้เปลี่ยนตัวแปรinputเป็นชื่อเต็ม จากนั้นเปลี่ยนตัวย่อของดอกไพ่ให้เป็นชื่อเต็ม
```
...
```text
มีinputเป็นค่า2หลักและเข้าmatch case อันเดียว
```
