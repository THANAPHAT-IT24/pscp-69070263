...
```text
รับค่ามาแล้วหารหาร10 แล้วคูณ 10 ให้เลขท้ายกลายเป็น0 ใช้ for loop printเริ่มที่ x stop ทีั่ 0 step ทีละลบ 10
```
...
```text
รับค่าแล้วเอามาลบ10เรื่อยๆให้ถึง0
```
...
```text
เอาค่าที่รับมาทำให้ตัวท้ายเป็น0ก่อน
```
...
```text
เป็นเลขที่ดูง่ายถ้าเกิด error จะ ตรวจจับได้ง่าย
```
