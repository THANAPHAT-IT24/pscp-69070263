...
```text
ให้รับค่าสี RGB มา2สีแล้วนำ2สีมาผสมกันแล้วแสดงผล
```
...
```text
รับค่าโดยใช้map split แล้ว เอาแต่ละสีมาหาค่าเฉลี่ย แล้วแสดงผลด้วย f string
```
...
```text
เป็นคนละสีและ แต่ละสี RGB ไม่เหมือนกัน
```
