...
```text
ให้ขนาดของแต่ละแปลงมาและให้จำนวนพื้นที่ ให้หาจำนวนแปลงที่แบ่งออกมาแล้วว่าได้กี่แปลง
```
...
```text
นับจำนวนช่องในแปลงแรกแล้วเอามาบวกกับแปลงที่2ที่มีlแถวแล้วบวกกับแปลงที่2ที่แถวไม่ครบlแล้วทำไปเรื่อยๆจนกว่าจะครบnแล้วดูว่าทำไปกี่ครั้ง
```
...
```text
คิด1แปลงเป็นรูป4เหลี่ยมแล้วเอามาหาร2จะได้จำนวนช่องในแปลงนั้น แล้วดูว่าคิดไปกี่ครั้งถึงจะครบจำนวนช่องที่ต้องใช้ แล้วแสดงผล(ว่าลูปไปกี่ครั้ง)
```
...
```text
แปลงแรกมีเต็มแต่เกินมาแค่1ช่องควรนับเป็นแปลงใหม่
```
...
```text
อธิบายโจทย์ให้เข้าใจ สอนวิธีคิด
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำความเข้าใจเอง เขียนโค้ดเอง 
```
