...
```text
รับค่า4ค่าแล้วให้ดูว่าในระหว่างค่านั้นมีตัวที่หารแล้วเหลือเศษที่ต้องการไหม
```
...
```text
รับค่าเริ่มกับจบแล้วเอามาหารค่าที่จะหารแล้วดูว่าเหลือเศษเท่าไหร่ถ้าตรงกับเศษที่ต้องการให้แสดงผลออกมา
```
...
```text
เหมอืนแผนแรกรับค่าเริ่มกับจบแล้วเอามาหารค่าที่จะหารแล้วดูว่าเหลือเศษเท่าไหร่ถ้าตรงกับเศษที่ต้องการให้แสดงผลออกมา
```
...
```text
เป็นเลขที่ทำนาย output ได้ง่าย
```
...
```text
เลขที่หารด้วย1แล้วเหลือเศษ0ควรเป็นทุกตัวในrange
```
