...
```text
OJ3024- [LEARNING LOGS] SurprisingVote
```
...
```text
รับค่า2ค่า หาเลขตํ่าที่สุดแล้วหาระยะห่างคะแนนถ้ามากกว่า2 ให้แสดงผล Surprising ถ้าไม่ ให้แสดงผล Not Surprising
```
...
```text
เอาเลขมากสุดลบตัวที่2กับ3แล้วหาความห่างคะแนน
```
...
```text
หาค่าน้อยสุดก่อนค่อยหารระยะห่าง
```
...
```text
เลขที่แต่ละคนน่าจะคะแนนใกล้กัน
```
...
```text
เลขที่ถ้าทั้ง3บวกกันแล้วยังไม่ถงผลรวม
```
...
```text
บอกวิธีคิดค่าน้อยสุด กับ ทำให้ค่าระยะห่างไม่ติดลบ
```

คุณยังทำอะไรด้วยตนเอง

```text
สูตรคิดเอง เขียนโค้ดและเรียงลำดับขั้นตอนเอง
```
