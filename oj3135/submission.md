...
```text
โจทย์ให้หาจำนวนคนที่ได้ถือของขวัญที่ส่งเป็นวงกลมและข้ามคนตามจำนวนที่รับมาจนกว่าจะวนครบหรือของขวัญไปตกที่โจร
```
...
```text
วนรูปแล้วบวกตามจำนวนคนที่ข้ามไปเรื่อยๆถ้าเกินจำนวนคนให้หยุดหรือถ้าไปตกที่คนที่เป็นโจรให้หยุด
```
...
```text
เริ่มนับจากคนที่1แล้ววนลูปคำนวณตำแหน่งถัดไปในวงกลมแล้วเพิ่มค่าจำนวนคนที่ถือของขวัญจนกว่าจะวนกลับมาที่เดิมหรือส่งถึงโจร
```
...
```text
คนแรกเป็นขโมยควรจะได้ถือของขวัญคนเดียว
```
...
```text
อธิบายโจทย์เพราะอ่านไม่เข้าใจ
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ด ทดสอบ คิด testcase ส่งโค้ดต้วยตนเอง
```
